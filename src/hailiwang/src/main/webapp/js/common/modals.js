var common_modals = function() {
	...
	var initModals = function() {
		...
		$modal.css({"margin-top":"0","background-color":"#ffffff","width":"40%","right":"30%","height":"100%","top":"20%"});
		/*
	...
	var deptRadioDiaLog = function(deptId, deptName, checkedIds){//ids默认选中：4
		var url = "/jf/tkamcbbc/company/toUrl";
		var data = { "toUrl" : "/platform/department/radio.html", "ids" : checkedIds, "enId" : deptId, "enterpriseName" : enterpriseName };
