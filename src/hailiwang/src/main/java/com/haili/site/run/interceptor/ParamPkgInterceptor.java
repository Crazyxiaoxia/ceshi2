...
import com.haili.site.common.SplitPage;
import com.haili.site.contants.ConstantWebContext;
import com.haili.site.tools.ToolDateTime;
...
public class ParamPkgInterceptor implements Interceptor {
    ...
    private void setRequestValue(BaseController controller, Field field) {
        try {
            ...
            if (null == value || (value instanceof String && ((String) value).isEmpty() || value instanceof Logger)) {// 参数值为空直接结束
